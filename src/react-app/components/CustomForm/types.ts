...
export interface RenderHeaderContext {
  title?: string;
  description?: string;
  theme: IFormTheme;
...
export interface RenderActionsContext {
...
export interface FormProps {
  ...
  labels?: FormLabels;
  translate?: TranslateFn;
  renderHeader?: (context: RenderHeaderContext) => ReactNode;
  renderActions?: (context: RenderActionsContext) => ReactNode;
  renderField?: (context: RenderFieldContext) => ReactNode;
}
